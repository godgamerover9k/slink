...
(async()=>{
 ...
 ck('pointing at the right file', win.$('getExe').getAttribute('href'), 'slink-gen-win-x64.exe');
 ...
 await wait(1200);
 ck('a mac is offered a mac build', /macos/.test(mac.$('getExe').getAttribute('href')||''), true);
